...
| R11 | Perda de acesso administrativo (chave SSH perdida, conta de nuvem/GitHub/Cloudflare comprometida) | Continuidade | Baixa | Crítico | **Alto** | 2FA em todas as contas de infraestrutura (GitHub já ativo), cópia da chave SSH privada em local seguro (não só no notebook) | ✅ Implementado — 2FA confirmado ativo em GitHub, Oracle Cloud, Cloudflare e no Gmail dedicado (GitHub já estava ativo antes deste projeto; os outros três confirmados em 2026-09-22) |
